...
try:
    # UPDATED: Changed filename to match your provided code
    model = load_model('pneumonia_resnet_best_model_1.h5')
...
def predict():
    # The key for the file in the form data should be 'image'
